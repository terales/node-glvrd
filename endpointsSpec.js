export default {
  ...
  "endpoints": {
    ...
    "postProofread": {
      ...
      "queryParams": ["app", "session"],
      "body": ["text"],
      "responseExample": { // Текст: Можно ли представить современный мир без ссылок? Едва ли. И до недавнего времени сервис «Главред» никак не отвечал на вызовы времени, связанные с необходимостью создания гипертекстовых связей в Глобальной паутине.
        "status": "ok",
        "fragments": [
